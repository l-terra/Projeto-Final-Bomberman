...
void iniciarNovoJogo(char*** mapa, PosicaoMapa* playerGridPosicao, Vector2* playerPosition, int* bombasDisponiveis, int* vidasJogador, int* pontuacaoJogador, int cellSize);
